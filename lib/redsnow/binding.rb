...
module RedSnow
  ...
  module Binding
    ...
    attach_function('sc_data_structures_handle', 'sc_data_structures_handle', [:pointer], :pointer)
    attach_function('sc_data_structures_description', 'sc_data_structures_description', [:pointer], :string)
    attach_function('sc_data_structure_collection_handle', 'sc_data_structure_collection_handle', [:pointer], :pointer) 
    attach_function('sc_data_structure_collection_size', 'sc_data_structure_collection_size', [:pointer], :int)
    attach_function('sc_data_structure_handle', 'sc_data_structure_handle', [:pointer, :int], :pointer)
    attach_function('sc_data_structure_name', 'sc_data_structure_name', [:pointer], :string)
    attach_function('sc_data_structure_description', 'sc_data_structure_description', [:pointer], :string)
    attach_function('sc_members_collection_handle', 'sc_members_collection_handle', [:pointer], :pointer) 
    attach_function('sc_members_collection_size', 'sc_members_collection_size', [:pointer], :int) 
    attach_function('sc_sample_handle', 'sc_sample_handle', [:pointer], :pointer)
